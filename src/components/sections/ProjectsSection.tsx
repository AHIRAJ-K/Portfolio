  ...
  const projects = [
    {
      ...
      image: "https://github.com/AHIRAJ-K/Portfolio/blob/main/Images/Digital-lock-system.png?raw=true",
    ...
    },
    {
      ...
      description: "Built a laser-based LiFi communication system using On-Off Keying. Text entered on the transmitter Arduino is converted to 8-bit ASCII, sent via a 650nm laser, detected by a BPW34 photodiode, and displayed on a 16x2 LCD.",
      image: "https://github.com/AHIRAJ-K/Portfolio/blob/main/Images/Lifi.png?raw=true",
    ...
    },
    {
      ...
      image: "https://github.com/AHIRAJ-K/Portfolio/blob/main/Images/Laser-security-system.png?raw=true",
